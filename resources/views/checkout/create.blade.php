                            ...
                            <form action="{{route('checkout.store', $camp->id)}}" class="basic-form" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="occupation" type="text" class="form-control {{ $errors->has('occupation') ? 'is_invalid' : '' }}" value="{{ old('occupation') ?: Auth::user()->occupation }}" required> 
                                                                                                                                                {{-- old digunakan agar user tdk perlu input lagi ketika sudah ada data lama --}}
                                ...
                                <div class="mb-5">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="cvc" type="number" class="form-control {{ $errors->has('cvc') ? 'is_invalid' : '' }}" maxlength="3" value="{{ old('expired') ?: '' }}" required>
                                            @if ($errors->has('cvc'))
